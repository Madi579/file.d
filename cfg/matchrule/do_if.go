...
// type fieldsValsMap struct {
// 	data map[string][]byte
// }

// func newFieldsValsMap() *fieldsValsMap {
// 	return &fieldsValsMap{
// 		data: make(map[string][]byte),
// 	}
// }

// func (f *fieldsValsMap) Set(key string, val []byte) {
// 	f.data[key] = val
// }

// func (f *fieldsValsMap) Get(key string) ([]byte, bool) {
// 	val, ok := f.data[key]
// 	return val, ok
// }

// func (f *fieldsValsMap) Clean() {
// 	for k := range f.data {
// 		delete(f.data, k)
// 	}
// }
